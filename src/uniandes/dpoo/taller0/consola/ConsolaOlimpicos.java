...
public class ConsolaOlimpicos
{
	...
	/** 
	 * Este método le pide al usuario el nombre de un atleta, busca el atleta con ese
	 * nombre y le informa al usuario el nombre del país al cual representa este
	 * atleta. 
	 */
	private void ejecutarPaisPorAtleta()
	{
		...
		String nombreAtleta = input("Porfavor ingrese el nombre del atleta: ");
		String pais = calculadora.buscarPaisporAtleta(nombreAtleta);
		System.out.println("El país al cual " + nombreAtleta + " representa es: " + pais);
